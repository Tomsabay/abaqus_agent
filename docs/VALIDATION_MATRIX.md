...
|---|---|---|---|---|---|
| 2026-06-02 | GitHub Actions, Ubuntu, Python 3.10/3.11/3.12 | Not installed | Unit tests + package build | PASS | CI run `26802874254`, `252 passed`, build passed |
...
- Windows + Abaqus 2021: full benchmark run across all public cases after the QA kernel stabilizes.
