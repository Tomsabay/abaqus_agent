"""
Tests for failure auto-repair (features.autorepair).
No Abaqus installation required.
"""


from features.autorepair.diagnosis import _rule_based_diagnosis
from features.autorepair.log_parser import (
    DiagnosticCategory,
    ParseResult,
    parse_job_diagnostics,
)
from features.autorepair.repair_strategies import apply_repairs, can_retry
